import numpy as np
from constants import FLOAT, ZER
...
def plane1vec1pt(vec1, pt):
    D = - vec1.array[0] * pt.array[0] \
        - vec1.array[1] * pt.array[1] \
        - vec1.array[2] * pt.array[2]
    return Plane(vec1.array[0], vec1.array[1], vec1.array[2], D)
def plane3points(pt1, pt2, pt3):
    tmp = np.array([[1., pt1.array[1], pt1.array[2]],
                    [1., pt2.array[1], pt2.array[2]],
                    [1., pt3.array[1], pt3.array[2]]], dtype=FLOAT)
    A = arraydet(tmp)
    tmp = np.array([[pt1.array[0], 1., pt1.array[2]],
                    [pt2.array[0], 1., pt2.array[2]],
                    [pt3.array[0], 1., pt3.array[2]]], dtype=FLOAT)
    B = arraydet(tmp)        
    tmp = np.array([[pt1.array[0], pt1.array[1], 1.],
                    [pt2.array[0], pt2.array[1], 1.],
                    [pt3.array[0], pt3.array[1], 1.]], dtype=FLOAT)
    C = arraydet(tmp)        
    tmp = np.array([[pt1.array[0], pt1.array[1], pt1.array[2]],
                    [pt2.array[0], pt2.array[1], pt2.array[2]],
                    [pt3.array[0], pt3.array[1], pt3.array[2]]], dtype=FLOAT)
    D = -arraydet(tmp)         
